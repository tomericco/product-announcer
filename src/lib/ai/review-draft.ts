...
const REVIEW_SYSTEM = [
  ...
  "match its sections, their order, its headings, its spacing and any sign-off.",
  "The template is shown to you UNFILLED. Anything in {braces} marks a slot and describes what belongs",
  "there — the draft should have something fitting in that position, NOT the brace itself. A [media] marker",
  "is a slot for a screenshot or walkthrough that an editor adds later; the draft should carry it through",
  "unchanged, so its presence is correct and not a gap.",
  "Flag it as an issue if any brace, or the words inside one, survived into the draft as literal text — that",
  "is the worst outcome this check exists to catch, and it is unmistakable when you can see both documents.",
  "Judge only the shape. Which change the draft leads with, how much space each gets, and any number it",
  "states are editorial decisions already made — do not second-guess them, and do not ask for content the",
  "template cannot tell you is missing.",
