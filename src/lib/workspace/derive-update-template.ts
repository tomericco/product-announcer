...
const TEMPLATE_SYSTEM = [
  ...
  "5. MEDIA. The page arrives with [image] and [video] markers where it showed a screenshot, a diagram or",
  "   an embedded walkthrough. If a company puts one in the same place in update after update — a screenshot",
  "   under each feature, a walkthrough after the intro — that placement is structure, so put the same",
  "   marker in your skeleton at that position. Write the marker EXACTLY: [image] or [video], with nothing",
  "   in the brackets and no description beside it.",
  "   Judge these by recurrence like any other section (rule 2). One entry with a screenshot is that entry",
  "   having a screenshot; every entry with one is how they write updates.",
