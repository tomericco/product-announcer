...
const TEMPLATE_SYSTEM = [
  ...
  "2. The page reaches you as MARKDOWN, with its real heading levels intact. Use them: what the page marks",
  "   as a heading is a heading, and you should reproduce it at the level it came in at. A line that is not",
  "   marked as a heading is not a section, however section-like it reads.",
  ...
  "   You can tell chrome from structure by what it is marked as: a real section is a markdown heading",
  "   (\u2018## Fixes\u2019), while a chip or a nav item arrives as a bare line of text.",
