  ...
  return (
    <div className="space-y-2">
      ...
      {/* The key, because the second number in a cell is not self-explanatory
          and the tooltip only reaches a reader who already wondered. */}
      <p className="text-xs text-muted-foreground">
        A cell reads answers naming you out of answers collected. ·2 means two tracked competitors were named
        in them.
      </p>
